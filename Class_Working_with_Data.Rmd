...
```{r echo=FALSE, fig.align="right",  message=FALSE, warning=FALSE, cache=TRUE, out.width="100%"}
...
```{r echo=FALSE, fig.align="right",  fig.margin=TRUE,  message=FALSE, warning=FALSE, cache=TRUE, out.width="60%"}
...
```{r echo=FALSE,  message=FALSE, warning=FALSE, cache=TRUE, out.width="75%"}
