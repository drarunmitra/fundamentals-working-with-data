...
filepath <- here("data", "ahs-cab2014-chhattisgarh-bastar.csv")
...
# df |>
#   mutate(
#     bp_systolic_mean = (bp_systolic + bp_systolic_2_reading)/2 , # mean systolic
#     bp_diastolic_mean = (bp_diastolic + bp_diastolic_2reading)/2 # mean diastolic
#   ) |>
#   select(bp_systolic, bp_systolic_2_reading, bp_systolic_mean,
#          bp_diastolic, bp_diastolic_2reading, bp_diastolic_mean) |> # verify
#   View()

df <- # Step 4: reassign it back to `df` to save
  df |>  # Step 1: specify dataset
  mutate(
